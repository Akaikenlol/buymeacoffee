				...
				<div className="flex flex-col justify-center items-center text-center gap-5 mb-10">
					...
					<div className="flex gap-5 justify-center items-center">
						<Link
							...
							className="border-2 border-black rounded-full py-2 px-7 hover:scale-105 ease-in-out duration-200"
						>
							Visit help center
						</Link>
						<Link
				...
				{dropDownItems.map((data, index) => (
					<>
						<div className="flex justify-center items-center" key={index}>
							<button
								type="button"
								className="inline-flex w-[800px] justify-between gap-x-2 rounded-md bg-white px-5 py-5 font-semibold text-gray-400 shadow-sm ring-1 ring-inset ring-gray-400 hover:bg-gray-50"
								aria-expanded="true"
								aria-haspopup="true"
							...
							{data.isOpen && (
								<div
									className="absolute flex justify-center items-center gap-5 w-[800px] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
									role="dialog"
								...
								>
									<div
										...
										role="none"
									>
										<p className="text-justify text-gray-400 block w-[750px] px-4 py-2 text-sm leading-normal tracking-normal">
											{data.content}
										</p>
										<button
											type="button"
