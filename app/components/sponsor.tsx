...
const Sponsor = () => {
	return (
		<section className="w-full flex justify-center flex-col items-center gap-5 mb-28 mt-10">
			<div className="flex flex-col justify-center items-center text-center w-[650px]">
			...
			<div className="flex flex-col gap-5">
				<button className="bg-yellow-300 rounded-full py-4 text-center w-[300px]  hover:scale-105 ease-in-out duration-300  mt-5">
